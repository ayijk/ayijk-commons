...
import com.ayijk.commons.math.gen.BetaDistribution
...
class BetaDistributionTest {
  ...
  fun generateTest() {
    ...
    val dist1 = org.apache.commons.math3.distribution.BetaDistribution(alpha, beta)
    val dist2 = BetaDistribution(alpha, beta)
